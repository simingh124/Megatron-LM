...
#   NUM_READ_MEM_TOKENS=<int>       override the read-prefix token count (default: 16)
...
#   EXIT_INTERVAL=10
#   SEQ_LENGTH=2048 MICRO_BATCH_SIZE=10 GLOBAL_BATCH_SIZE=240
...
NUM_READ_MEM_TOKENS=${NUM_READ_MEM_TOKENS:-16}
