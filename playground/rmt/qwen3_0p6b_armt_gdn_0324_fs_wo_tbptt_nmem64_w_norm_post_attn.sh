...
# - Switch ARMT recurrent-memory writes from mem tokens to post-attention context states.
...
ARMT_MEMORY_WRITE_SOURCE=${ARMT_MEMORY_WRITE_SOURCE:-post_attn_context}
