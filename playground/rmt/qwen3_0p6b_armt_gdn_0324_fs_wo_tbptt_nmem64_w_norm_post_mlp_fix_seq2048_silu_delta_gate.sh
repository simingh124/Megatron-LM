...
# - Inject recurrent memory readouts with silu_delta_gate instead of residual addition.
...
#   - ARMT_READ_INJECTION_MODE=residual|silu_delta_gate|sigmoid_gate
...
ARMT_READ_INJECTION_MODE=${ARMT_READ_INJECTION_MODE:-silu_delta_gate}
...
ARMT_ARGS=(
  ...
  --armt-read-injection-mode ${ARMT_READ_INJECTION_MODE}
)
...
echo "ARMT_READ_INJECTION_MODE=${ARMT_READ_INJECTION_MODE}"
