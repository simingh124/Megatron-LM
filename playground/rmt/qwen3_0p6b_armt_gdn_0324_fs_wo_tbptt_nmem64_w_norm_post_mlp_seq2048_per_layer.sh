...
# Qwen3-0.6B ARMT GDN smoke launcher for per-layer read-prefix concat mode.
#
# Reference launcher:
...
# - Use per-layer read-memory embeddings for associate() queries.
...
ARMT_READ_MEMORY_MODE=${ARMT_READ_MEMORY_MODE:-per_layer}
