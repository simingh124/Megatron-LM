...
# - Apply a dedicated recurrent memory max LR override (default 2.5e-3).
#
...
RECURRENT_MEMORY_LR=${RECURRENT_MEMORY_LR:-2.5e-3}

# ========== Training parameters ==========
MICRO_BATCH_SIZE=${MICRO_BATCH_SIZE:-15}
...
ARMT_ARGS=(
  ...
  --recurrent-memory-lr ${RECURRENT_MEMORY_LR}
)
...
echo "RECURRENT_MEMORY_LR=${RECURRENT_MEMORY_LR}"
